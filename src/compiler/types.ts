...
export interface Identifier extends PrimaryExpression, Declaration, JSDocContainer {
...
export interface PropertyAccessExpression extends MemberExpression, NamedDeclaration, JSDocContainer {
...
export interface ElementAccessExpression extends MemberExpression, Declaration, JSDocContainer {
